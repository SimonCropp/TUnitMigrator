...
public class SerilogNuGetLogger : ILogger
{
    ...
    public void LogDebug(string data) => Serilog.Log.Debug(data);
    public void LogVerbose(string data) => Serilog.Log.Verbose(data);
    public void LogInformation(string data) => Serilog.Log.Information(data);
    public void LogMinimal(string data) => Serilog.Log.Information(data);
    public void LogWarning(string data) => Serilog.Log.Warning(data);
    public void LogError(string data) => Serilog.Log.Error(data);
    public void LogInformationSummary(string data) => Serilog.Log.Information(data);

    public void Log(LogLevel level, string data) => Serilog.Log.Write(MapLogLevel(level), data);
